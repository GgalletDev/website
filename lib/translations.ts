...
export const translations: Record<"en" | "fr", TranslationDict> = {
  en: {
    ...
    cardSubtitle: "The website is currently under construction. The first project is being prepared behind the scenes.",
    cardProtocol: "PROTOCOL LINK",
    cardOnline: "ONLINE",
    cardText: "Stay tuned! You can contact me directly by clicking the email button below for any questions, ideas, or exchanges.",
  ...
  fr: {
    ...
    cardSubtitle: "Le site est actuellement en cours de construction. Le premier projet se prépare en coulisses.",
    cardProtocol: "LIAISON PROTOCOLE",
    cardOnline: "EN LIGNE",
    cardText: "Restez dans les parages ! Vous pouvez me contacter directement en cliquant sur le bouton d'e-mail ci-dessous pour toute question, idée ou échange.",
    cardBadge: "SMASH_DICE // ARCADE",
