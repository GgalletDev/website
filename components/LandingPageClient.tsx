...
export default function LandingPageClient({ locale }: LandingPageClientProps) {
  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex-1 flex flex-col max-w-6xl mx-auto w-full px-6 sm:px-12 py-4 justify-between">
            ...
            <div className="relative bg-zinc-950/40 backdrop-blur-xl border border-white/[0.05] hover:border-white/[0.08] transition-colors rounded-2xl p-6 sm:p-8 flex flex-col justify-center">
              <div className="space-y-6 py-4">
                ...
                <div className="text-center">
                  <Link href={`/${locale}/games/smash-dice`} className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-zinc-950/30 border border-blue-500/40 text-blue-300 hover:bg-zinc-950/50 transition-colors backdrop-blur-sm">
                    {t("game1PlayButton")}
        ...
        {/* 
================================================================================
SECTION: GAMES SHOWCASE (LEGACY VERSION)
Kept temporarily for reference during media/gallery refactor.
Can be safely removed once GameMediaGallery component is fully integrated.
================================================================================
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="relative aspect-video rounded-xl bg-zinc-950/80 border border-white/[0.06] overflow-hidden flex flex-col items-center justify-center text-center p-6 group/video">
              ...
              <div className="z-10 space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <span className="block text-[10px] font-mono text-blue-400/80 animate-pulse">
                    {t("mediaVideoPlaceholder")}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              {[1, 2, 3].map((num) => (
                <div
                  key={num}
                  className="relative aspect-video rounded-lg bg-zinc-950/40 border border-dashed border-white/[0.06] hover:border-blue-500/20 transition-all duration-300 flex flex-col items-center justify-center text-center p-2 group/screen"
                >
                  <div className="text-zinc-600 group-hover/screen:text-blue-400/60 transition-colors">
                    ...
                    >
                      <path
                        ...
                        d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.9 2.9m-18 0V4.5A2.25 2.25 0 014.5 2.25h15a2.25 2.25 0 012.25 2.25v13.5m-18 0h18M9 10.5h.008v.008H9V10.5z"
                      />
                    </svg>
                  </div>
