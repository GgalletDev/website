...
export const metadata = {
  title: 'Privacy Policy – Smash Dice',
  description: 'Privacy policy for Smash Dice game.',
};
    ...
    <>
      ...
      <main className="min-h-screen bg-[#03000a] text-zinc-100 flex flex-col items-center justify-center p-8">
        ...
        <section className="max-w-2xl">
          <p className="text-zinc-300">[Stub content] This page will contain the privacy policy for the Smash Dice game.</p>
        </section>
      </main>
    </>
  );
