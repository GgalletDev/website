...
export const metadata = {
  title: 'Contact – Smash Dice',
  description: 'Contact information for the Smash Dice game.',
};
    ...
    <>
      ...
      <main className="min-h-screen bg-[#03000a] text-zinc-100 flex flex-col items-center justify-center p-8">
        ...
        <section className="max-w-2xl">
          <p className="text-zinc-300">[Stub content] This page will contain contact details or a form for the Smash Dice game.</p>
        </section>
      </main>
    </>
  );
