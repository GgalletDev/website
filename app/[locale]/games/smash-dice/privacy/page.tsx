...
const documents = {
  fr: () => import('@/content/legal/smash-dice/privacy/fr.mdx'),
  en: () => import('@/content/legal/smash-dice/privacy/en.mdx'),
};
...
export const generateMetadata = async ({
  ...
  const title =
    locale === 'fr'
      ? 'Politique de confidentialité – Smash Dice'
      : 'Privacy Policy – Smash Dice';

  const description =
    dict?.privacyMetaDesc ||
    'Privacy policy for the Smash Dice game.';
  ...
  return {
    ...
    alternates: {
      languages: {
        en: '/en/games/smash-dice/privacy',
        fr: '/fr/games/smash-dice/privacy',
      },
    },
  };
};
...
export default async function PrivacyPage({
  ...
  const loadDocument =
    documents[locale as keyof typeof documents];
